...
echo ========================================
echo.
echo 1. Start prod services (nginx + Node.js)
echo 2. Stop all services
echo 3. Start dev services
...
start "UCMS Web Server" cmd /c "npm run prod"
...
start "UCMS WebSocket Server" cmd /c "npm run prod"
...
start "UCMS WebSocket Server" cmd /c "npm run dev"
