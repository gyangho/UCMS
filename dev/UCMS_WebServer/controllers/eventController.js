...
class EventController {
    ...
    static isMultipleEvent(eventData) {
        return new Date(eventData.start).toDateString() !== new Date(eventData.end).toDateString();
    }
    ...
    static async createEvent(req, res) {
        try {
            ...
            eventData.isRecruiting = eventData.isRecruiting === "on";
            ...
            eventData.ismultiple = EventController.isMultipleEvent(eventData);
