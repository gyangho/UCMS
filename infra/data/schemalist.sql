...
CREATE TABLE pos_instances (
  ...
  created_by INT DEFAULT NULL COMMENT 'users.id 참조',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  closed_at DATETIME DEFAULT NULL,
  INDEX idx_pos_instances_creator (created_by),
  CONSTRAINT fk_pos_instances_creator
...
CREATE TABLE inquiry_comments (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  inquiry_id BIGINT UNSIGNED NOT NULL COMMENT 'inquiry_posts.id 참조',
  author_id INT DEFAULT NULL COMMENT 'users.id 참조',
  author_name VARCHAR(50) NOT NULL COMMENT '작성 당시 이름',
